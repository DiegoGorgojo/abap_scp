CLASS zcl_carga_biblioteca_4086 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_carga_biblioteca_4086 IMPLEMENTATION.

METHOD if_oo_adt_classrun~main.

data: lt_acc_categ type table of ztb_acc_categ_86,
          lt_catego    type table of ztb_catego_86,
          lt_clientes  type table of ztb_clientes_86,
          lt_clnts_lib type table of ztb_clnts_lib_86,
          lt_libros    type table of ztb_libros_86.
...
******** ztb_acc_categ_86 ********
    ...
    delete from ztb_acc_categ_86.
    insert ztb_acc_categ_86 from table @lt_acc_categ.
...
******** ztb_catego_86 ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_catego_86.
    insert ztb_catego_86 from table @lt_catego.
...
******** ztb_clientes_86 ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_clientes_86.
    insert ztb_clientes_86 from table @lt_clientes.
...
******** ztb_clnts_lib_86
    ...
    "Delete possible entries; insert new entries
    delete from ztb_clnts_lib_86.
    insert ztb_clnts_lib_86 from table @lt_clnts_lib.
...
******** ztb_libros_86 ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from ztb_libros_86.
    insert ztb_libros_86 from table @lt_libros.
